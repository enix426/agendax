...
export function afficheDansCase(serveurDate, idCalendrier) {
    ...
    serveurDate.forEach((dateDuServeur, evt) => {
        ...
        if (index != -1) {
            ...
            //trouver le ul
            let listEvenement = document.querySelector(
                "#date-" + dateDuServeur.date + " ul"
            );
            ...
            for (let i = 0; i < Object.keys(serveurDate[evt]).length + 2; i++) {
                ...
                if (i < Object.keys(serveurDate[evt]).length) {
                    eTrEvenement.appendChild(eTdEvenement).innerHTML = Object.values(
                        serveurDate[evt]
                    )[i];
                }
                ...
                if (i == Object.keys(serveurDate[evt]).length) {
                    ...
                    let eIcone = document.createElement("i");
                    eTrEvenement.appendChild(ePEvenement).appendChild(eIcone);
                    eTrEvenement.appendChild(ePEvenement).setAttribute("id", "myBtn");
                    eTrEvenement
                        .appendChild(ePEvenement)
                        .setAttribute("class", "far fa-edit");
                    ...
                    ePEvenement.addEventListener("click", function() {
                        ...
                        document.getElementById("formModifierEvenement").style.visibility =
                            "visible";
